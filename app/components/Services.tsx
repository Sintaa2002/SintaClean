...
export const services: Service[] = [
  {
    ...
    heroImg: "/photos/dubsinko-ciscenje-zagreb.webp",
    heroImgMob: "/photos/dubinsko-ciscenje-namjestaja.webp",
  ...
  {
    usluge: "ciscenje-ureda-zagreb",
    title: "Čišćenje i održavanje poslovnih prostora i ureda u Zagrebu i okolici",
    titleDesc: "Profesionalno čišćenje poslovnih prosotra i ureda",
    subTitle: "Uredni i higijenski radni prostori za bolji dojam i produktivnost",
    description:
    ...
    heroImg: "/photos/ciscenje-ureda-zapresic-zagreb.webp",
    heroImgMob: "/photos/ciscenje-ureda-zapresic-zagreb.webp",
  ...
  },
  {
    ...
    heroImg: "/photos/kosnja-trave-zagreb.webp",
    heroImgMob: "/photos/kosnja-trave-zagreb.webp",
  ...
  {
    usluge: "dubinsko-automobila-zagreb",
    title: "Dubinsko čišćenje automobila Zagreb i okolica",
    titleDesc: "Dubinsko čišćenje sjedista i auto tepiha",
    subTitle: "Detaljno čišćenje unutrašnjosti za osjećaj novog automobila",
    description:
    ...
    heroImg: "/photos/dubinsko-ciscenje-automobila.webp",
    heroImgMob: "/photos/dubinsko-ciscenje-automobila.webp",
...
{
    usluge: "ciscenje-radijatora-zagreb",
    title: "Čišćenje radijatora Zagreb i okolica",
    titleDesc: "Čišćenje i dezinfekcija radijatora Zagreb, Zaprešić, Samobor i okolica",
    subTitle: "Uklanjanje prašine i bakterija iz radijatora",
    description:
    ...
    image: "/photos/radijatori-ciscenje-zagreb.webp",
    heroImg: "/photos/ciscenje-radijatora-zagreb-zapresic.webp",
    heroImgMob: "/photos/ciscenje-dezinfekcija-klime-radijatora.webp",
